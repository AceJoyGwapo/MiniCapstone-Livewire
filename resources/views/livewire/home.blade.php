    ...
    <div class="">
        ...
        <div class="row mx-auto mt-5 mb-3 d-flex justify-content-between">
            ...
            <div class="col-md-4 text-white mb-5">
                <div class="card" style="height: 550px; background-color:rgb(0, 42, 121)">
                    <div class="mt-2 mx-4">
            ...
            <div class="container">
                <div id="carouselExample" class="carousel slide">
                    <div class="carousel-inner">
                        @foreach ($feeds->chunk(3) as $index => $chunk)
                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                <div class="row justify-content-center">
                                    @foreach ($chunk as $feed)
                                        <div class="col-md-3">
                                            <div class="card mb-3 buttonpage">
                                                <img src="{{ asset('storage') }}/{{ $feed->band->image }}" class="img-fluid mt-2 mb-2"
                                                    alt="..." data-bs-toggle="modal" data-bs-target="#viewMusic{{ $feed->band->id }}">
                                                <div class="card-body">
                                                    <div class="details">
                                                        <h6 class="card-title">{{ $feed->band->bandName }}</h6>
                                                        <label class="card-text"><span class="fst-italic">Location:</span> <span
                                                                class="fw-semibold">{{ $feed->band->location }}</span></label>
                                                        <label class="card-text"><span class="fst-italic">Rate:</span> <span
                                                                class="fw-semibold">P{{ $feed->band->rate }}</span></label><br>
                                                        <label class="card-text"><span class="fst-italic">Genre:</span> <span
                                                                class="fw-semibold">{{ $feed->band->genre }}</span></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="d-flex justify-content-between mx-auto">
                    ...
                    <h3 class="fst-italic">Choose your band...</h3>
                ...
                <div class="container">
                    ...
                    @foreach ($bands as $band)
                        <div data-bs-toggle="modal" data-bs-target="#viewBand{{ $band->id }}"
                            class="card mb-3 btnh shadow-lg mx-auto" style="max-width: 400px;">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-3 ms-auto">
                                        <a type="button" data-bs-toggle="modal"
                                            ...
                                            <svg wire:click="editProfile({{ $band->id }})"
                                                ...
                                                viewBox="0 0 16 16" style="color:rgb(4, 0, 255)">
                                                <path
